...
//  CryptoApp
//
//  Created by Назар Горевой on 25.08.2023.
//
...
class HomeViewModel: ObservableObject {
    ...
    private let portfolioDataService = PortfolioDataSerivice()
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let portfoliio = StatisticModel(title: "Portfolio Value", value: portfolioValue.asCurrencyWith2Decimals(), percentageChange: percentageChange)
